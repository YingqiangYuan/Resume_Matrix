...
为什么这些素材必须留在 GitHub: **AI 改你简历的时候要用**。你跟 AI 说「帮我把这条 bullet 改一下, 突出医疗领域的 AI 落地」, AI 不会凭空写, 它需要去翻你的 case 文档看你到底做了什么。这些素材是 AI 的弹药库, 没有这些素材, AI 只能瞎编。

这就是为什么**简历的内容源头必须留在 GitHub**: 不是因为 git 多酷, 是因为只有这里有 AI 工作所需要的全套上下文。这一点没得商量。
