...
| [01-industry.md](01-industry.md) | US 医疗数据分析与数字健康软件行业怎么运作？商业模式、行业体量、生命周期阶段、监管框架、未来 3-5 年的 AI 与互操作性走向？ |
| [02-company.md](02-company.md) | Cascadia 自家近 24 个月发生了什么？业绩、产品、客户结构、领导层、Customer-Embedded Engineering 团队定位、未来 3-5 年路径与 PE 退出窗口？ |
| [03-role.md](03-role.md) | "AI Solutions Engineer 嵌在 Customer Success 团队"日常是什么？entry / mid / senior 差别？AI 自动化窗口？转 Core Product Engineering 难度？ |
| [04-market.md](04-market.md) | PNW AI Solutions Engineer / Forward Deployed Engineer 当前行情？healthcare AI vendor vs FAANG 薪资差距？5 年 hiring 走势？ |
